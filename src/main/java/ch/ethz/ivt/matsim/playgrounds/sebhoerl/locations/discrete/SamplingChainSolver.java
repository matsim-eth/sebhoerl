...
public class SamplingChainSolver implements DiscreteChainSolver {
    ...
    public SamplingChainSolver(ContinuousChainSolver chainSolver, long numberOfIterations) {
        this.chainSolver = chainSolver;
        this.numberOfIterations = numberOfIterations;
    }

    @Override
    public Result findDiscreteLocations(Vector2D originLocation, Vector2D destinationLocation, List<Double> distances, List<Double> convergenceThresholds, List<LocationDiscretizer> discretizers) {
