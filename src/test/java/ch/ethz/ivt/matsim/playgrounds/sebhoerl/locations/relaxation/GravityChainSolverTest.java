...
public class GravityChainSolverTest {
    ...
    public void testTwoDistanceChain() {
        GravityChainSolver solver = new GravityChainSolver(0.1, 1e-6, 1000);
        ...
        Assert.assertTrue(result.isSolved());
    ...
    public void testDirectLoop() {
        GravityChainSolver solver = new GravityChainSolver(0.1 ,1e-3, 1000);
